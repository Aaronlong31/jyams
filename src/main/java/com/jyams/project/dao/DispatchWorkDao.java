...
public class DispatchWorkDao extends IBatisEntityDao<DispatchWork> {
	...
	public void batchInsert(List<DispatchWork> dispatchWorks) {
		...
		getSqlMapClientTemplate().insert("com.jyams.project.model.DispatchWork.batchInsert", map);
	}
	...
	public DataPage<DispatchWork> listDispatchWorks(Long projectId, Long personId,
		...
		return pagedQuery("com.jyams.project.dao.DispatchWorkDao.listDispatchWorks", map, pageNo,
				pageSize);
	}
	...
	public int checkDuplicateTime(int dispatchDay, int startTime, int endTime, long personId) {
		...
		return (Integer) getSqlMapClientTemplate().queryForObject(
				"com.jyams.project.dao.DispatchWorkDao.checkDuplicateTime", map);
	}
}
