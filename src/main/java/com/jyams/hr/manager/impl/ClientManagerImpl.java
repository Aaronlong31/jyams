...
public class ClientManagerImpl implements ClientManager {
    ...
    @Override
    public ClientPrincipal addClientPrincipal(long clientId,
    ...
    public Client getClient(long clientId) {
        ...
        List<ClientPrincipal> clientPrincipals = clientPrincipalDao.findBy(
    ...
    @Override
    public List<ClientPrincipal> listClientPrincipals(
            String clientPrincipalNameLike) {
    ...
    public DataPage<ClientPrincipal> listClientPrincipals(Long clientId,
        ...
        return clientPrincipalDao.listClientPrincipals(clientId,
                clientNameLike, clientPrincipalNameLike, pageNo, pageSize);
    }
}
