...
public class OperateLog {
    ...
    public static final Map<Integer, String> TYPE_STRING_MAP = Maps
            .newHashMap();
    public static final Map<Integer, String> MODULE_STRING_MAP = Maps
            .newHashMap();
    public static final Map<Integer, String> MODEL_STRING_MAP = Maps
            .newHashMap();
    ...
    public void log() {
        log(operatorId, operatorName, operateType, operateInfo, operateModule,
                modelId, operateModel, ip);
    }

    public static void log(long operatorId, String operatorName,
            int operateType, String operateInfo, int operateModule,
            String modelId, Integer operateModel, String ip) {
        ...
        MDC.put("modelId",
                (modelId == null || modelId.trim().length() == 0) ? ""
                        : modelId);
        MDC.put("ip", ip);
