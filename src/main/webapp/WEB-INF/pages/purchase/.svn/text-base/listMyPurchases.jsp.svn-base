...
<div class="content contentwidth">
	<div class="main_panel">
		<h3 class="crumbs">
		<img src="../images/sidebar_h3_bg1.gif" alt="" />当前位置：<a href="#">首页</a>我的采购单</h3>
...
$(function(){
	...
	$("#purchaseList").jqGrid({
		url : "${ctx}/purchase/listMyPurchases_json.action",
		datatype : "json",
		colNames : ["操作","采购单ID", "采购单编号", "类型", "状态", "申请人","申请时间", "指定到货日期", "送货地址" , "收货人"],
		caption : "我的采购单列表",
		colModel : [
		...
		gridComplete : function(){
			...
			$.each(ids, function(i, id){
				var approval = "<a href=\"view.action?purchaseId="+id+"\">查看</a>";
