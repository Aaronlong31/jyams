...
<div class="content contentwidth">
	<div class="main_panel">
		<h3 class="crumbs">
		<img src="../images/sidebar_h3_bg1.gif" alt="" />当前位置：<a href="#">首页</a>二审采购</h3>
...
$(function(){
	...
	var buildSelectF = function(xmlHttpRequest){
		...
		$.each(data.persons, function(i, person){
			$("<option value="+person.personName+">"+person.personName+"</option>").appendTo(select);
		});
		return "<select>" + select.html() + "</select>";
	};
	$("#purchaseList").jqGrid({
		url : "${ctx}/purchase/order/secondApproveList_json.action",
		datatype : "json",
		colNames : ["操作","采购单ID", "采购单编号", "申请人","申请时间"],
		caption : "待审核的采购单列表",
		colModel : [
		...
		gridComplete : function(){
			...
			$.each(ids, function(i, id){
				var approval = "<a href=\"toApprove.action?approveNum=2&purchaseId="+id+"\">审核</a>";
