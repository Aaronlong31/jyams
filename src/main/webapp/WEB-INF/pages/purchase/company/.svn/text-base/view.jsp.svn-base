		...
		<div class="main_content two_rows">
				<div class="main_content">
					<table class="table_normal">
						...
						<tr>
							<td class="td_first">审批人：</td>
							<td><s:property value="purchase.approverName" /></td>
							<td class="td_first">审批时间：</td>
							<td><j:dateTimeFormat value="purchase.approvedTimestamp"/></td>
						</tr>
						<tr>
							<td class="td_first">审批意见：</td>
							<td colspan="2"><s:property value="purchase.approvalOpinion"/></td>
						</tr>
					</table>
				</div>
			</div>
...
$(function(){
	...
	$("#modify").click(function(){
		window.location.href = "${ctx}/purchase/company/input.action?purchaseId=${purchase.purchaseId}&type=2";
	});
	$("#printPurchaseBtn").click(function(){
		//window.location.href = "${ctx}/purchase/company/print.action?purchaseId=${purchase.purchaseId}";
		window.open("${ctx}/purchase/company/print.action?purchaseId=${purchase.purchaseId}", "_blank", "location=no,menubar=no,status=no,toolbar=no");
	});
});
</script>
</html>