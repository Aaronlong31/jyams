							...
							<table class="table_normal">
                            	<thead>
                                	<tr>
                                        ...
                                        <th style="width:10%;text-align:center;">施工编号</th>
                                        <th style="width:15%;text-align:center;">施工内容</th>
                                ...
                                <tbody id="purchaseDetail">
                                    <s:iterator value="purchase.purchaseItems" status="status">
                               			<tr class="viewPurchase purchaseItemId_${purchaseItemId}" purchaseItemId="${purchaseItemId}">
	                                      	...
	                                      	<td style="text-align:center;padding: 0;" id="" title="<s:property value="projectName"/>">
