...
<body>
	...
	<div class="main_panel">
		...
		<div class="main_content two_rows">
				<div class="main_content">
					<table class="table_normal">
						...
						<tr>
							...
							<td><j:dateTimeFormat value="purchase.arrivalDate" pattern="yyyy-MM-dd"/></td>
						</tr>
						<tr>
							<td class="td_first">指定收货人:</td>
							<td><s:property value="purchase.consigneeName" /></td>
							<td class="td_first">实际到货日期:</td>
							<td><j:dateTimeFormat value="purchase.purchaseTimestamp" /></td>
						</tr>
						<tr>
				...
				<div class="main_content">
		            <div class="tableBox" style="top:175px">
					<table class="table_normal" style="width: 1000px;">
						<thead>
							<tr>
								<th style="width:4%;text-align:center;">序号</th>
								<th style="width:13%;text-align:center;">项目编号</th>
								<th style="width:23%;text-align:center;">项目内容</th>
								<th style="width:13%;text-align:center;">品名</th>
								<th style="width:8%;text-align:center;">规格型号</th>
								<th style="width:8%;text-align:center;">数量</th>
								<th style="width:8%;text-align:center;">单位</th>
								<th style="width:8%;text-align:center;">单价</th>
								<th style="width:8%;text-align:center;">金额</th>
						...
						<tbody>
							<s:iterator value="purchase.purchaseItems" status="sta">
								<tr>
									...
									<td style="text-align: center;"><s:property value="projectId"/></td>
...
$(function(){
	...
	$("#modify").click(function(){
		window.location.href = "${ctx}/purchase/material/input.action?purchaseId=${purchase.purchaseId}&type=1";
	});
	$("#printPurchaseBtn").click(function(){
		//window.location.href = "${ctx}/purchase/material/print.action?purchaseId=${purchase.purchaseId}";
		window.open("${ctx}/purchase/material/print.action?purchaseId=${purchase.purchaseId}", "_blank", "location=no,menubar=no,status=no,toolbar=no");
	});
});
</script>
</html>