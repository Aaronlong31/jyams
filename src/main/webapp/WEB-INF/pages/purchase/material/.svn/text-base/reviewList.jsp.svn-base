...
<div class="content contentwidth">
	<div class="main_panel">
		<h3 class="crumbs">
		<img src="../images/sidebar_h3_bg1.gif" alt="" />当前位置：<a href="#">首页</a>复核采购</h3>
...
$(function(){
	...
	$("#purchaseList").jqGrid({
		url : "${ctx}/purchase/material/reviewList_json.action",
		datatype : "json",
		...
		gridComplete : function(){
			...
			$.each(ids, function(i, id){
				var approval = "<a href=\"toReview.action?purchaseId="+id+"\">复核</a>";
