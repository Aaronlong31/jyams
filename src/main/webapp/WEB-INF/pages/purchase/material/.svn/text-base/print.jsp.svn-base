...
<div style="vertical-align: middle;text-align: center;">
	<table style="margin: 0 auto;">
		<thead>
			<tr>
				<th colspan="7" style="font-size: large;">无锡市金业科技有限公司</th>
			</tr>
			<tr>
				<th colspan="7" style="font-size: large;">WUXI JINYE TECHNOLOGY CO.,LTD</th>
			</tr>
			<tr>
				<th colspan="7" style="font-weight: bold;height:100px;font-size: 25px;vertical-align: middle;">物料申购单</th>
			</tr>
			<tr>
				<th colspan="7">
					<table width="100%">
			...
			<tr id="head">
				<th class="title" style="width: 67px">序号</th>
				<th class="title" style="width: 124px">施工编号</th>
				<th class="title" style="width: 240px">品名</th>
